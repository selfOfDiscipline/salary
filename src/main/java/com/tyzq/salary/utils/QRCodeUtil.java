...
import com.tyzq.salary.config.BufferedImageLuminanceSource;
...
public class QRCodeUtil {
    ...
    //二维码标识
    private static final String SIGN = "TYZQ";
    ...
    public static String sign(String code){
        ...
        buffer.append(UUID.randomUUID()).append(",").append(SIGN).append(",").append(code);
        return buffer.toString();
    }

    public static String encodeSign(String code) throws Exception {
